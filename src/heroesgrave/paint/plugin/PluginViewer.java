...
import heroesgrave.paint.gui.AboutDialog;
...
public class PluginViewer
{
	...
	{
		dialog = new WebDialog(Paint.main.gui.frame, "Plugin Viewer");
	...
	public class PluginListItem
	{
		...
		public void constructText(JTextPane pluginInfoArea)
		{
			...
			if(info.has("min-paint-version"))
			{
				...
				{
					AboutDialog.append(doc, info.get("min-paint-version") + " - " + info.get("max-paint-version"), "regular");
				}
				else
				{
					AboutDialog.append(doc, info.get("min-paint-version") + "+", "regular");
				}
			}
			else if(info.has("max-paint-version"))
			{
				AboutDialog.append(doc, "<" + info.get("max-paint-version"), "regular");
			}
			else
			{
