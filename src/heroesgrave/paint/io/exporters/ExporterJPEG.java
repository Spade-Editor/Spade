...
package heroesgrave.paint.io.exporters;
...
public class ExporterJPEG extends ImageExporter
{
	...
	public BufferedImage clean(BufferedImage imageIn)
	{
		...
		BufferedImage imageOut =
				new BufferedImage(imageIn.getWidth(), imageIn.getHeight(),
	...
	{
		writeImage(clean(doc.getRenderedImage()), getFileExtension()
				.toUpperCase(), destination.getAbsolutePath());
	}
